...
function FloatingDock() {
  ...
  const items = [
    { icon: <WhatsAppIcon />, href: "https://wa.me/YOUR_WHATSAPP_NUMBER", label: "WhatsApp", bg: "linear-gradient(135deg,#25D366,#128C7E)", glow: "rgba(37,211,102,0.4)" },
    { icon: <InstagramIcon />, href: "https://instagram.com/fenz.digital", label: "Instagram", bg: "linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)", glow: "rgba(220,39,67,0.35)" },
